...
let newMixCounter = 0;
const newMixListeners = new Set<() => void>();
...
function LockIcon({ size = 14, locked = false }: { size?: number; locked?: boolean }) {
  return locked
    ? h("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "currentColor" },
...
function MixIcon({ size = 16 }: { size?: number }) {
  return h("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2.5, strokeLinecap: "round", strokeLinejoin: "round" },
...
function AsciiWave({ active, mini }: { active: boolean; mini?: boolean }) {
...
function MixLabel({ isNewMix }: { isNewMix?: boolean }) {
